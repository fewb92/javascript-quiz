...
var questions = [
    ...
    {
        prompt: 'What is a method in JavaScript?',
    ...
    {
        prompt: 'What is the correct syntax for linking to an external file called script.js?',
        choices: ['<script = script.js/>', '<script src="script.js">', '<script src="script.js/>', '<script: script.js>'],
        answer: '1'
    },
    {
        prompt: 'What functionality can be built with Javascript?',
    ...
    {
        prompt: 'What does const represent in Javascript',
